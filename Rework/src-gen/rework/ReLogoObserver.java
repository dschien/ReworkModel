...
public class ReLogoObserver extends BaseObserver{
	...
	public AgentSet<rework.relogo.Worker> createWorkers(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("rework.relogo.Worker")
	public AgentSet<rework.relogo.Worker> createWorkers(int number) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("rework.relogo.Worker")
	public AgentSet<rework.relogo.Worker> createOrderedWorkers(int number, Closure closure) {
		AgentSet<rework.relogo.Worker> result = new AgentSet<>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("rework.relogo.Worker")
	public AgentSet<rework.relogo.Worker> createOrderedWorkers(int number) {
	...
	public AgentSet<rework.relogo.Worker> workers(){
		...
		for (Object e : this.getContext().getObjects(rework.relogo.Worker.class)) {
	...
	public AgentSet<rework.relogo.UserLink> userLinks(){
		...
		for (Object e : this.getContext().getObjects(rework.relogo.UserLink.class)) {
	...
	public rework.relogo.UserLink userLink(Number oneEnd, Number otherEnd) {
		return (rework.relogo.UserLink)(this.getNetwork("UserLink").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
