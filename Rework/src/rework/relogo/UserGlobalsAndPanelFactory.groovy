...
public class UserGlobalsAndPanelFactory extends AbstractReLogoGlobalsAndPanelFactory{
	public void addGlobalsAndPanelComponents(){
		addSliderWL ("reworkRate", "Rework Rate", 0 , 1 ,100, 50)
		addSliderWL ("numWorkers", "Number of Workers", 1 , 10 , 100 , 50)		
		addSliderWL ("numJobs", "Number of Jobs", 1 , 100 , 1000 , 500)		
		addMonitorWL ("remainingJobs", "Remaining Jobs", 1)
		addMonitorWL ("reworkedJobs", "Reworked Jobs", 1)
		/**
